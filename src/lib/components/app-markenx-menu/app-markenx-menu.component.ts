...
@Component({
  ...
  styleUrls: ['./app-markenx-menu.component.scss'],
})
export class AppMarkenxMenuComponent implements AppMarkenxMenu, AfterViewInit {
  ...
  public enabledItems: Array<AppMarkenxMenuItemComponent> = [];
  ...
  public selectItem(value: string) {
    ...
    this.enabledItems.forEach((item) => item.updateSelection(this.selectedValue));
