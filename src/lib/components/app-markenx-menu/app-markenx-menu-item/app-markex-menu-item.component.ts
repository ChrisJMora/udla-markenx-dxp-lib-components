...
import { AppMarkenxMenuComponent as AppMarkenxMenuComponent } from '../app-markenx-menu.component';
...
@Component({
  ...
  styleUrls: ['./app-markenx-menu-item.component.scss'],
})
export class AppMarkenxMenuItemComponent implements AppMarkenxMenu, OnInit {
  ...
  private isSubItemSelected(valueSelected: string): boolean {
    ...
    return this.item.subItems!.some((subItem) => subItem.value === valueSelected);
  }
}
